...
|---|---|---|---|
| Zumbido eléctrico 60 Hz (armónicos 120/180/240 Hz) al grabar con Audient iD14 | El ruido viaja por el rail USB 5V desde la PSU de la PC, alimentado por un UPS CyberPower de onda simulada | Aislador USB con chip **ADuM3165** (480 Mbps) — modelo DSD TECH SH-G01B. El ADUM3160 común NO sirve (solo 12 Mbps). Ver [[wiki/conceptos/diagnostico-ruido-electrico]] | ⚠️ Diagnóstico posterior al 13 jun puede cambiar esto — confirmar |
