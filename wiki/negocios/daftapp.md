...
> ⚠️ Pendiente: Instalar analítica (Google Analytics o Plausible) para medir uso real.
> ⚠️ Pendiente: Resolver conflicto del link de bio de @mercadoernesto (hoy: Calendly). Decidir cómo convivir daftapp + clases en el único link disponible.
> ⚠️ Pendiente: Crear página propia de daftapp (posible Wix) con CTA único a la app, sin links competidores.
> ⚠️ Pendiente: Email #2 a los 283 que abrieron — con botón CTA único, sin CTAs duplicados.
